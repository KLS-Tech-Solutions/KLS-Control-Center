...
>(({ className, invalid, ...props }, ref) => (
  <input
    ...
    className={cn(
      "h-11 w-full rounded-field border border-line bg-white px-4 text-[15px] text-ink outline-none transition-colors",
...
>(({ className, invalid, rows = 5, ...props }, ref) => (
  <textarea
    ...
    aria-invalid={invalid || undefined}
    className={cn(
      "w-full rounded-field border border-line bg-white px-4 py-3 text-[15px] leading-relaxed text-ink outline-none transition-colors",
...
>(({ className, invalid, ...props }, ref) => (
  <select
    ...
    aria-invalid={invalid || undefined}
    className={cn(
      "h-11 w-full appearance-none rounded-field border border-line bg-white px-4 text-[15px] text-ink outline-none transition-colors",
